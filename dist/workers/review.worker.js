...
const worker = new Worker("review-processing", // must match the queue name
async (job) => {
    const { reviewId } = job.data;
    console.log(`[Worker] Processing review ${reviewId} (job ${job.id}, attempt ${job.attemptsMade + 1})`);
